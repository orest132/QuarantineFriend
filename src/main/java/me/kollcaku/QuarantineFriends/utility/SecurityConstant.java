...
public class SecurityConstant {
    ...
    public static final String[] PUBLIC_URLS = {"/api/forget-password","/api/hobby","/api/hobby/user/*", "/api/hobbies","/api/hobbies/report","/api/register","/api/login","/api/subscribe", "/swagger*/*", "/swagger-ui.html", "/v3/api-docs","/v3/api-docs/*"};
    public static final String[] ONLY_ADMIN_URLS = {"/api/user/ban/*","/api/user/delete/*","/api/delete/**"};
}